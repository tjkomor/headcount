...
class EconomicProfileTest < Minitest::Test
  ...
  def setup
    @free_or_reduced_lunch_data = {
      2014=>0.329, 2012=>0.333, 2011=>0.314,
      2010=>0.273, 2009=>0.259, 2013=>0.357,
      2008=>0.227, 2007=>0.23, 2006=>0.196,
      2005=>0.209, 2004=>0.146, 2003=>0.15,
      2002=>0.132, 2001=>0.112, 2000=>0.09
    }
  ...
  def test_it_can_find_school_aged_children_in_poverty
    dr = DistrictRepository.from_json(data_dir)
    district = dr.find_by_name('WOODLAND PARK RE-2')
    assert_equal @school_aged_children_in_poverty_data, district.economic_profile.school_aged_children_in_poverty_by_year
  end
